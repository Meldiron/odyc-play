export const translations = {
	en: {
		...
		'marketplace.empty': 'No apps available yet.',
		'marketplace.previous': 'Previous',
		'marketplace.next': 'Next',
		'marketplace.of': 'of',
		'marketplace.viewDetails': 'View details',
		'marketplace.untaggedApp': 'App',
		'marketplace.noDescription': 'No description provided.',
		'marketplace.screenshots': 'Screenshots',
		'marketplace.about': 'About',
		'marketplace.links': 'Links & resources',
		'marketplace.homepage': 'Homepage',
		'marketplace.support': 'Support',
		'marketplace.privacy': 'Privacy policy',
		'marketplace.terms': 'Terms of service',
		'marketplace.dataDeletion': 'Data deletion',
		'marketplace.contact': 'Contact',
		'marketplace.backToApps': 'Apps',
		'marketplace.notFound': 'This app could not be found.',
		'marketplace.openApp': 'Open app',
		...
		'games.createWebEditor': 'Web editor',
		'games.createWebEditorBadge': 'Recommended',
		'games.createWebEditorDescription': 'Build and play right in your browser. No setup.',
		'games.createCli': 'CLI',
		'games.createCliDescription': 'Scaffold and deploy from your terminal.',
		...
		// Marketplace listing metadata (developer settings)
		'apps.marketplace': 'Marketplace',
		'apps.marketplaceDescription':
			'This information is shown on your app’s public marketplace listing and on the OAuth2 consent screen.',
		'apps.tagline': 'Tagline',
		'apps.taglinePlaceholder': 'A short, catchy one-liner',
		'apps.taglineHint': 'A brief summary shown under your app name. Keep it concise.',
		'apps.appDescription': 'Description',
		'apps.appDescriptionPlaceholder': 'Describe what your app does and why people should use it.',
		'apps.logoUri': 'Logo',
		'apps.logoUriHint': 'Square PNG or JPG, from 128×128 to 1024×1024, up to 5MB.',
		'apps.clientUri': 'Homepage URL',
		'apps.supportUrl': 'Support URL',
		'apps.privacyPolicyUrl': 'Privacy policy URL',
		'apps.termsUrl': 'Terms of service URL',
		'apps.dataDeletionUrl': 'Data deletion URL',
		'apps.contacts': 'Contact email',
		'apps.tags': 'Category',
		'apps.tagsHint': 'Helps people discover your app in the marketplace.',
		'apps.categoryPlaceholder': 'Select a category',
		'apps.images': 'Screenshots',
		'apps.imagesHint': 'Landscape PNG or JPG, at least 1280×720 (HD), up to 5MB each.',
		'apps.optional': 'Optional',

		// Image upload
		'apps.uploadLogo': 'Upload logo',
		'apps.uploadScreenshot': 'Add screenshot',
		'apps.uploadClick': 'Click to upload',
		'apps.uploading': 'Uploading…',
		'apps.removeImage': 'Remove',
		'apps.imageTypeError': 'Only PNG and JPG images are allowed.',
		'apps.imageSizeError': 'Image must be 5MB or smaller.',
		'apps.imageReadError': 'Could not read that image file.',
		'apps.logoSquareError': 'Logo must be a square image.',
		'apps.logoDimensionError': 'Logo must be between 128×128 and 1024×1024 pixels.',
		'apps.screenshotLandscapeError': 'Screenshots must be landscape (wider than tall).',
		'apps.screenshotHdError': 'Screenshots must be at least 1280×720 (HD).',
		'apps.imageUploaded': 'Image uploaded.',
		'apps.imageRemoved': 'Image removed.',
		...
		'consent.scope.gamesRead': 'Read your games and their code',
		'consent.scope.gamesCreate': 'Create new games on your behalf',
		'consent.scope.gamesWrite': "Edit your games' code",
		'consent.selectGame': 'Choose which games to grant access to:',
		'consent.gameAccessAll': 'All games',
		'consent.gameAccessSpecific': 'Specific games',
		'consent.gameAccessNone': 'No games',
		'consent.gameAccessAllHint': 'Includes every game you own now, and any you create later.',
		'consent.gameAccessNoneHint': "This permission won't apply to any of your games.",
		'consent.gameSearchPlaceholder': 'Search your games…',
		'consent.gameAddPlaceholder': 'Add a game…',
		'consent.gameNoResults': 'No matching games found.',
		'consent.gameSelectedEmpty': 'No games selected yet.',
		'consent.removeGame': 'Remove game',
		'consent.gamePermissions': 'It will be allowed to:',
		'consent.noGames': "You don't have any games yet. Create one first to grant access.",
		'consent.action.codeWrite': "Edit and publish the game's code",
		// OAuth2 device flow
	...
	fr: {
		...
		'marketplace.empty': 'Aucune application disponible pour le moment.',
		'marketplace.previous': 'Précédent',
		'marketplace.next': 'Suivant',
		'marketplace.of': 'sur',
		'marketplace.viewDetails': 'Voir les détails',
		'marketplace.untaggedApp': 'Application',
		'marketplace.noDescription': 'Aucune description fournie.',
		'marketplace.screenshots': "Captures d'écran",
		'marketplace.about': 'À propos',
		'marketplace.links': 'Liens et ressources',
		'marketplace.homepage': "Site de l'application",
		'marketplace.support': 'Support',
		'marketplace.privacy': 'Politique de confidentialité',
		'marketplace.terms': "Conditions d'utilisation",
		'marketplace.dataDeletion': 'Suppression des données',
		'marketplace.contact': 'Contact',
		'marketplace.backToApps': 'Applications',
		'marketplace.notFound': 'Cette application est introuvable.',
		'marketplace.openApp': "Ouvrir l'application",
		'marketplace.verified': 'Vérifié',
		'marketplace.tags': 'Étiquettes',
		...
		'games.createWebEditor': 'Éditeur web',
		'games.createWebEditorBadge': 'Recommandé',
		'games.createWebEditorDescription': 'Créez et jouez directement dans votre navigateur. Aucune installation.',
		'games.createCli': 'CLI',
		'games.createCliDescription': 'Générez et déployez depuis votre terminal.',
		...
		// Marketplace listing metadata (developer settings)
		'apps.marketplace': 'Place de marché',
		'apps.marketplaceDescription':
			"Ces informations sont affichées sur la fiche publique de votre application et sur l'écran de consentement OAuth2.",
		'apps.tagline': 'Accroche',
		'apps.taglinePlaceholder': 'Une phrase courte et accrocheuse',
		'apps.taglineHint': "Un bref résumé affiché sous le nom de votre application. Restez concis.",
		'apps.appDescription': 'Description',
		'apps.appDescriptionPlaceholder':
			'Décrivez ce que fait votre application et pourquoi les gens devraient l’utiliser.',
		'apps.logoUri': 'Logo',
		'apps.logoUriHint': 'PNG ou JPG carré, de 128×128 à 1024×1024, jusqu’à 5 Mo.',
		'apps.clientUri': 'URL du site',
		'apps.supportUrl': 'URL du support',
		'apps.privacyPolicyUrl': 'URL de la politique de confidentialité',
		'apps.termsUrl': "URL des conditions d'utilisation",
		'apps.dataDeletionUrl': 'URL de suppression des données',
		'apps.contacts': 'E-mail de contact',
		'apps.tags': 'Catégorie',
		'apps.tagsHint': 'Aide les utilisateurs à découvrir votre application dans la place de marché.',
		'apps.categoryPlaceholder': 'Choisir une catégorie',
		'apps.images': "Captures d'écran",
		'apps.imagesHint': 'PNG ou JPG paysage, au moins 1280×720 (HD), jusqu’à 5 Mo chacune.',
		'apps.optional': 'Facultatif',

		// Image upload
		'apps.uploadLogo': 'Téléverser un logo',
		'apps.uploadScreenshot': 'Ajouter une capture',
		'apps.uploadClick': 'Cliquez pour téléverser',
		'apps.uploading': 'Téléversement…',
		'apps.removeImage': 'Supprimer',
		'apps.imageTypeError': 'Seules les images PNG et JPG sont autorisées.',
		'apps.imageSizeError': "L'image doit faire 5 Mo ou moins.",
		'apps.imageReadError': "Impossible de lire ce fichier image.",
		'apps.logoSquareError': 'Le logo doit être une image carrée.',
		'apps.logoDimensionError': 'Le logo doit faire entre 128×128 et 1024×1024 pixels.',
		'apps.screenshotLandscapeError': 'Les captures doivent être en paysage (plus larges que hautes).',
		'apps.screenshotHdError': 'Les captures doivent faire au moins 1280×720 (HD).',
		'apps.imageUploaded': 'Image téléversée.',
		'apps.imageRemoved': 'Image supprimée.',
		...
		'consent.scope.gamesRead': 'Lire vos jeux et leur code',
		'consent.scope.gamesCreate': 'Créer de nouveaux jeux en votre nom',
		'consent.scope.gamesWrite': 'Modifier le code de vos jeux',
		'consent.selectGame': "Choisissez les jeux auxquels accorder l'accès :",
		'consent.gameAccessAll': 'Tous les jeux',
		'consent.gameAccessSpecific': 'Jeux spécifiques',
		'consent.gameAccessNone': 'Aucun jeu',
		'consent.gameAccessAllHint':
			'Inclut tous les jeux que vous possédez actuellement, ainsi que ceux que vous créerez plus tard.',
		'consent.gameAccessNoneHint': "Cette autorisation ne s'appliquera à aucun de vos jeux.",
		'consent.gameSearchPlaceholder': 'Rechercher vos jeux…',
		'consent.gameAddPlaceholder': 'Ajouter un jeu…',
		'consent.gameNoResults': 'Aucun jeu correspondant.',
		'consent.gameSelectedEmpty': 'Aucun jeu sélectionné pour le moment.',
		'consent.removeGame': 'Retirer le jeu',
		'consent.gamePermissions': 'Cela lui permettra de :',
		'consent.noGames': "Vous n'avez encore aucun jeu. Créez-en un d'abord pour accorder l'accès.",
		'consent.action.codeWrite': 'Modifier et publier le code du jeu',
		// OAuth2 device flow
